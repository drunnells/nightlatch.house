...
<div class="debug-shell" id="debug-player">
    ...
    <aside class="debug-console">
        ...
        <div class="console-section"><div class="console-section-heading"><h3>Items</h3><button class="icon-button gold" data-add-state="items"><i class="fa-solid fa-plus"></i></button></div><div id="items-state"></div></div>
