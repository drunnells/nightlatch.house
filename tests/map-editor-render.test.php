...
$files = array(
    ...
    'roomJs' => file_get_contents($root . '/assets/js/room-editor.js'),
...
$expectations = array(
    ...
    array('mapJs', 'pickerTooltip(sound.name, sound.slug)', 'Ambient sound picker tooltips are missing.'),
    array('room', 'id="target-room-picker"', 'The searchable room target picker is missing.'),
    array('roomJs', 'pickerTooltip(candidate.title, disabledDetail)', 'Room target picker tooltips are missing.'),
