...
- The player client must remain polished and playable on mobile and desktop. Present transient rule messages as non-resizing right-side slide-outs that dismiss automatically, keep explicitly opened room/object descriptions visible until closed without moving focus or shifting the viewport, preserve the complete content image in the available viewport, and place prominent description and fullscreen controls directly on room and object artwork.
