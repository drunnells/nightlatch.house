...
4. The agent can inspect and patch the visible unsaved draft. You explicitly approve saving, discarding, and Gemini overlay generation in that panel.
...
- Save and generation are user-approved in the page that is visibly being edited.
